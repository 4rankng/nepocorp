...
id auto increment
account_payable_id int (foreign key to account_payable table)
item_name string
price int (in VND)
quantity int
total int (in VND)
...
Table account_receivable_items
id auto increment
account_receivable_id int (foreign key to account_receivable table)
item_name string
price int (in VND)
quantity int
total int (in VND)
