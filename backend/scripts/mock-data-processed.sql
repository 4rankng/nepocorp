...
-- Note: Replace your-hash-secret-change-in-production and your-hash-salt-change-in-production with actual values from .env
-- ================================================================

-- Set MySQL variables for hashing (replace with actual .env values)
SET @hash_secret = 'your-hash-secret-change-in-production';  -- Replace with actual HASH_SECRET from .env
SET @hash_salt = 'your-hash-salt-change-in-production';      -- Replace with actual HASH_SALT from .env
...
INSERT IGNORE INTO users (id, username, email, password, name, role, is_active) VALUES
...
INSERT IGNORE INTO containers (id, category) VALUES
(1, '20ft'),
(2, '40ft'),
(3, '40ft-HC'),
(4, '45ft'),
...
INSERT IGNORE INTO tractors (id, license_plate, description) VALUES
(1, '51A-12345', 'Xe đầu kéo Hyundai 2020'),
(2, '51B-67890', 'Xe đầu kéo Hino 2019'),
(3, '51C-11111', 'Xe đầu kéo Isuzu 2021'),
(4, '51D-22222', 'Xe đầu kéo Mitsubishi 2018'),
(5, '51E-33333', 'Xe đầu kéo Daewoo 2022');

-- Insert mock trailers  
INSERT IGNORE INTO trailers (id, license_plate, description) VALUES
(1, '51R-11111', 'Rơ moóc container 40ft'),
(2, '51R-22222', 'Rơ moóc container 20ft'),
(3, '51R-33333', 'Rơ moóc sàn 45ft'),
(4, '51R-44444', 'Rơ moóc tank chở xăng'),
(5, '51R-55555', 'Rơ moóc thùng kín');
...
(1, 1, NULL, 'Garage Minh Tuấn', 1, 2000000, 10, 2200000, 'PAID', 'VND', 'Bảo dưỡng định kỳ 10,000km', 2, 2),
(2, 2, NULL, 'Xưởng Hùng Vương', 1, 1500000, 10, 1650000, 'PENDING', 'VND', 'Thay dầu và lọc', 2, 2),
(3, 3, NULL, 'Bảo hiểm PTI', 2, 5000000, 0, 5000000, 'PAID', 'VND', 'Bảo hiểm xe 1 năm', 1, 1),
(4, 1, NULL, 'Cửa hàng phụ tùng ABC', 5, 800000, 10, 880000, 'DRAFT', 'VND', 'Thay phanh trước', 3, 3),
(5, 4, NULL, 'Garage Thành Đạt', 1, 3000000, 10, 3300000, 'PAID', 'VND', 'Sửa chữa động cơ', 2, 2);

-- Insert mock expenses for trailers
INSERT IGNORE INTO expenses (id, tractor_id, trailer_id, vendor_name, expense_category_id, subtotal, tax_rate, total, payment_status, currency, remark, created_by, last_updated_by) VALUES
(6, NULL, 1, 'Xưởng Hoàng Gia', 1, 1200000, 10, 1320000, 'PAID', 'VND', 'Bảo dưỡng hệ thống phanh', 2, 2),
(7, NULL, 2, 'Garage Việt Nam', 1, 900000, 10, 990000, 'PENDING', 'VND', 'Thay lốp xe', 2, 2),
(8, NULL, 3, 'Bảo hiểm Bảo Việt', 2, 3000000, 0, 3000000, 'PAID', 'VND', 'Bảo hiểm rơ moóc', 1, 1),
(9, NULL, 4, 'Cửa hàng Minh Châu', 5, 600000, 10, 660000, 'DRAFT', 'VND', 'Thay van an toàn', 3, 3),
(10, NULL, 5, 'Xưởng sơn Tấn Phát', 1, 2500000, 10, 2750000, 'PAID', 'VND', 'Sơn lại thùng xe', 2, 2);
...
INSERT IGNORE INTO maintenance (id, expense_id, license_plate, vendor_name, item_name, price, quantity, tax_rate, total, install_date, expiry_date) VALUES
(1, 1, '51A-12345', 'Garage Minh Tuấn', 'Bảo dưỡng định kỳ 10,000km', 2000000, 1, 10.0, 2200000, '2024-01-15', '2024-07-15'),
(2, 2, '51B-67890', 'Xưởng Hùng Vương', 'Thay dầu và lọc động cơ', 1500000, 1, 10.0, 1650000, '2024-02-01', '2024-08-01'),
(3, 4, '51A-12345', 'Cửa hàng phụ tùng ABC', 'Thay má phanh trước', 800000, 1, 10.0, 880000, '2024-02-10', '2025-02-10'),
(4, 5, '51D-22222', 'Garage Thành Đạt', 'Sửa chữa động cơ', 3000000, 1, 10.0, 3300000, '2024-01-20', NULL),
(5, 6, '51R-11111', 'Xưởng Hoàng Gia', 'Bảo dưỡng hệ thống phanh', 1200000, 1, 10.0, 1320000, '2024-02-05', '2025-02-05'),
(6, 7, '51R-22222', 'Garage Việt Nam', 'Thay lốp xe rơ moóc', 900000, 1, 10.0, 990000, '2024-02-15', NULL),
(7, 9, '51R-44444', 'Cửa hàng Minh Châu', 'Thay van an toàn khí nén', 600000, 1, 10.0, 660000, '2024-02-20', '2025-02-20'),
(8, 10, '51R-55555', 'Xưởng sơn Tấn Phát', 'Sơn lại thùng xe', 2500000, 1, 10.0, 2750000, '2024-01-25', NULL);

-- Insert mock settings
INSERT IGNORE INTO settings (id, `key`, `value`, last_updated_by) VALUES
(1, 'tax_rate', '10', 1),
(2, 'company_name', 'Nepo Corporation', 1),
(3, 'company_address', '123 Đường ABC, Quận 1, TP.HCM', 1),
(4, 'company_phone', '028-1234-5678', 1),
(5, 'maintenance_reminder_days', '30', 1),
(6, 'fuel_price_default', '25000', 1),
(7, 'insurance_renewal_reminder_days', '60', 1);
