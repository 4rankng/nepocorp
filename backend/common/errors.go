...
const (
	...
	ErrUpdateExpenseCategory  = "Lỗi khi cập nhật danh mục chi phí"
	...
	ErrUpdateContainer = "Lỗi khi cập nhật container"
	...
	ErrUpdateTractor = "Lỗi khi cập nhật đầu kéo"
	...
	ErrUpdateTrailer = "Lỗi khi cập nhật rơ moóc"
	...
	ErrUpdateTractorExpense = "Lỗi khi cập nhật chi phí đầu kéo"
	...
	ErrUpdateExpenseItem = "Lỗi khi cập nhật khoản chi phí"
	...
	ErrUpdateSetting = "Lỗi khi cập nhật cài đặt"
