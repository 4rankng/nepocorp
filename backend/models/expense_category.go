...
type ExpenseCategory struct {
	...
	CategoryKey   string    `gorm:"type:varchar(100);not null;uniqueIndex:uk_expense_categories_key" json:"category_key"`    // Unique identifier for system (English, no diacritics)
	Name          string    `gorm:"type:varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;not null" json:"name"` // Vietnamese name
...
func (ec *ExpenseCategory) BeforeSave(tx *gorm.DB) (err error) {
	ec.CategoryKey = strings.TrimSpace(ec.CategoryKey)
