export const AuditEvent = {
  ...
  VEHICLE_SCHEDULE_CREATED: 'VEHICLE_SCHEDULE_CREATED',
  VEHICLE_SCHEDULE_UPDATED: 'VEHICLE_SCHEDULE_UPDATED',
  VEHICLE_SCHEDULE_COMPLETED: 'VEHICLE_SCHEDULE_COMPLETED',
  VEHICLE_SCHEDULE_CANCELLED: 'VEHICLE_SCHEDULE_CANCELLED',
