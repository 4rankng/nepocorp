...
đổ hay tích checkbox: các dòng đã được tạo sẵn; người nhập **Số lít** tại đúng
nơi đã đổ và để trống các nơi còn lại. Dòng Cây dầu ngoài không gắn với công nợ
nhà cung cấp.

API chỉ lưu các dòng có số lít đã nhập và giữ tối đa hai chữ số thập phân cho số lít.
