...
- File Excel `CARRIER` ghi NEPO là **Bên thuê dịch vụ**, nhà vận chuyển là **Bên cung cấp dịch vụ**. Giá cước thuê ngoài đã gồm VAT nên tổng thanh toán giữ nguyên số tiền đã nhập, không cộng thêm 8%.
