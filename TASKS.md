...
- [x] **T4.1 — Integ: ledger balance integrity (parallel locks, same customer)** · `M` · BE · dep: T2.7
...
- [x] **T4.2 — Integ: deadlock prevention (two trips sharing entities)** · `M` · BE · dep: T2.7
...
- [x] **T4.3 — Integ: lock atomicity (forced mid-txn failure → full rollback)** · `M` · BE · dep: T2.7
...
- [x] **T4.4 — Integ: rate snapshotting (all 7 cols)** · `S` · BE · dep: T2.2
...
- [x] **T4.5 — Integ: optimistic concurrency (two PUTs same version → one 409)** · `S` · BE · dep: T2.5
...
- [x] **T4.6 — Integ: driver isolation (no sensitive cols in response)** · `S` · BE · dep: T2.16
...
- [x] **T4.7 — State-machine transition unit tests** · `M` · BE · dep: T2.8
