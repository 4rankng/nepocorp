...
import * as dinhMucDataService from '../../mockData/dinhMuc';
...
export const addDinhMuc = (data) => { // Renamed from createDinhMuc to follow convention like addKhachHang
  console.log('[Mock API] Creating Dinh Muc:', data);
  return simulateApiCall(() => dinhMucDataService.createDinhMuc(data));
};

export const editDinhMuc = (id, data) => { // Renamed from updateDinhMuc to follow convention
...
export const removeDinhMuc = (id) => { // Renamed from deleteDinhMuc to follow convention
...
export const _resetDinhMucApiData = (data) => { // Renamed for clarity
