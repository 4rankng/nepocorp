...
export const editNhanVien = (id, data) => {
  return mockApiCall(() =>
    withUpdate(
      () => nhanVienDataService.updateNhanVien(id, data),
      'Nhan vien not found',
...
export const removeNhanVien = id => {
  return mockApiCall(() =>
    withDelete(
      () => nhanVienDataService.deleteNhanVien(id),
      'Nhan vien not found',
...
export const _resetNhanVienMockData = data => {
  return mockApiCall(() =>
    createApiSingleResponse(
      nhanVienDataService._resetNhanVien(data),
      'Nhan vien data reset successfully'
    )
  );
};
