...
export const editCauHinh = (id, data) => {
  return mockApiCall(() => 
    withUpdate(() => cauHinhDataService.updateCauHinh(id, data), 'Cau hinh not found', 'Cau hinh updated successfully')
  );
};

export const editCauHinhByKey = (key, value) => {
  return mockApiCall(() => 
    withUpdate(() => cauHinhDataService.updateCauHinhByKey(key, value), 'Cau hinh not found', 'Cau hinh updated successfully')
  );
};

export const removeCauHinh = id => {
  return mockApiCall(() => 
    withDelete(() => cauHinhDataService.deleteCauHinh(id), 'Cau hinh not found', 'Cau hinh deleted successfully')
  );
};
...
export const updateDinhMucBoSung = value => {
  return mockApiCall(async () => {
    ...
    return createApiSingleResponse({ value: parseFloat(updated.value) }, 'Dinh muc bo sung updated successfully');
  });
};
...
export const _resetCauHinhApiData = data => {
  return mockApiCall(() => 
    createApiSingleResponse(cauHinhDataService._resetCauHinh(data), 'Cau hinh data reset successfully')
  );
};
