...
class MaintenanceService extends BaseService<MaintenanceRecord, CreateMaintenanceRequest, UpdateMaintenanceRequest> {
  constructor() {
    super('/maintenance');
  }

  // Override getAll to support maintenance-specific filters
  async getAll(params?: MaintenanceFilters & { page?: number; limit?: number }): Promise<ApiResponse<MaintenanceRecord[]>> {
