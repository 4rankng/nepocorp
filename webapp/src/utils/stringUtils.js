...
export const fixDoubleEncodedUTF8 = (str) => {
  ...
  try {
    ...
    const doubleEncodedPatterns = [
      'Ã', 'â', 'Ä', 'Ã©', 'Ã¡', 'Ã', 'Ã³', 'Ã­', 'Ãº', 'Ã½',
      'áº', 'áº£', 'áº¥', 'áº§', 'áº©', 'áº«', 'áº­', 'áº¯', 'áº±', 'áº³', 'áº·',
      'áº¹', 'áº»', 'áº½', 'áº¿', 'á»', 'á»', 'á»', 'á»', 'á»', 'á»'
    ];
...
export const removeVietnameseDiacritics = (str) => {
  ...
  return str.replace(/[áàảãạăắằẳẵặâấầẩẫậéèẻẽẹêếềểễệíìỉĩịóòỏõọôốồổỗộơớờởỡợúùủũụưứừửữựýỳỷỹỵđ]/g, 
...
export const containsVietnamese = (str) => {
  ...
  const vietnamesePattern = /[áàảãạăắằẳẵặâấầẩẫậéèẻẽẹêếềểễệíìỉĩịóòỏõọôốồổỗộơớờởỡợúùủũụưứừửữựýỳỷỹỵđ]/i;
