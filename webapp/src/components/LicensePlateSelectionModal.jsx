              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-3 max-h-80 overflow-y-auto pr-2">
                  {tractorPlates.length > 0 ? (
                    ...
                    <p className="col-span-full text-center text-gray-500 text-xs">Không tìm thấy biển số đầu kéo nào.</p>
                  )}
                </div>
              </div>
              <div>
                ...
                <div className="grid grid-cols-2 gap-3 max-h-80 overflow-y-auto pr-2">
                  {trailerPlates.length > 0 ? (
                    ...
                    <p className="col-span-full text-center text-gray-500 text-xs">Không tìm thấy biển số rơ moóc nào.</p>
                  )}
                </div>
              </div>
            </div>
