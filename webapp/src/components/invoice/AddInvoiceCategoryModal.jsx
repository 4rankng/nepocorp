...
const AddInvoiceCategoryModal = ({ open, onClose, onSuccess }) => {
  const { createCategory } = useInvoiceCategories();
    ...
    >
      <div className="space-y-4">
        ...
        <TextField
          ...
          error={!!errors.name}
          helperText={errors.name || 'Ví dụ: Vận chuyển Container, Dịch vụ Logistics'}
        ...
        <TextField
          ...
          fullWidth
          disabled={isSubmitting}
          placeholder="Mô tả chi tiết về danh mục phiếu thu này"
...
export default AddInvoiceCategoryModal;