...
import AddInvoiceCategoryModal from './AddInvoiceCategoryModal';
import { Button } from '@/components/ui/buttons';

const InvoiceCategoryModal = ({ open, onClose }) => {
  const {
    categories,
    isLoading,
    error,
  ...
  return (
    <>
      <StandardModal open={open} onClose={onClose}>
        <StandardModalHeader title="Quản lý Danh mục Phiếu thu" onClose={onClose} />
        ...
        <div className="flex-1 overflow-y-auto p-4 text-sm">
          ...
          <StandardTable
            ...
            loading={isLoading}
            emptyMessage="Không có danh mục phiếu thu nào"
            pagination={true}
      ...
      <ConfirmDialog
        ...
        type="delete"
        title="Xóa danh mục phiếu thu"
        message="Bạn có chắc chắn muốn xóa danh mục phiếu thu này?"
        details={
          deleteDialog.category
            ? {
                'Tên danh mục': deleteDialog.category.name,
                'Mô tả': deleteDialog.category.description || 'Không có mô tả',
              }
            : null
        }
      />
...
export default InvoiceCategoryModal;