...
const DinhMucDau = () => {
  ...
  return (
    <Box component="div" sx={{ p: isMobile ? 1 : 2, width: '100%' }}>
      ...
      {/* Render dialogs */}
      <DinhMucDialog open={openAddDialog} isEdit={false} isMobile={isMobile} formData={formData} errors={errors} onClose={() => setOpenAddDialog(false)} onSave={handleSaveAdd} onInputChange={handleInputChange} onValidateForm={validateForm} />
      <DinhMucDialog open={openEditDialog} isEdit={true} isMobile={isMobile} formData={formData} errors={errors} onClose={() => setOpenEditDialog(false)} onSave={handleSaveEdit} onInputChange={handleInputChange} onValidateForm={validateForm} />
