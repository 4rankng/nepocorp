...
const DinhMucRouter = () => {
  ...
  useEffect(() => {
    if (location.pathname === '/phuong-tien/dinh-muc') {
      navigate('/phuong-tien/dinh-muc/bo-sung', { replace: true });
    }
  }, [location.pathname, navigate]);

  const handleTabChange = (event, newValue) => {
    navigate(`/phuong-tien/dinh-muc/${newValue}`);
  };

  return (
    <Box sx={{ width: '100%', p: 2 }}>
      <h1 className="text-2xl font-bold mb-4">Định Mức</h1>
