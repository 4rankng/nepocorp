...
const DinhMucDialog = ({
  ...
  return (
    ...
    >
              ...
              <Grid item xs={12}>
                ...
                <Box component="div" sx={{ display: 'flex', gap: 1.5, width: '100%' }}>
                  <Box
                    component="div"
                    onClick={() =>
                      onInputChange({ target: { name: 'loaiDinhMuc', value: 'km_hang' } })
                    }
                    sx={{
                      flex: 1,
                      py: 1,
                  ...
                  <Box
                    component="div"
                    onClick={() =>
                      onInputChange({ target: { name: 'loaiDinhMuc', value: 'km_vo' } })
                    }
                    sx={{
                      flex: 1,
                      py: 1,
      ...
      <DialogActions
        sx={{
          p: isMobile ? '16px' : '16px 24px 24px',
          backgroundColor: isMobile ? 'background.default' : 'transparent',
        }}
      >
        <Button
          onClick={onClose}
