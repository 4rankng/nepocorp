...
const DauKeoDeleteDialog = ({ open, data, onClose, onConfirm, isLoading }) => (
  <Dialog
    ...
    aria-labelledby="delete-daukeo-dialog"
  >
    <DialogTitle id="delete-daukeo-dialog" sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
      <LocalShippingIcon color="error" />
      Xác nhận xóa đầu kéo
    </DialogTitle>
    <DialogContent>
      <DialogContentText>
        Bạn có chắc chắn muốn xóa đầu kéo sau đây? Hành động này không thể hoàn tác.
      </DialogContentText>
      <Box
        sx={{
          mt: 2,
