    ...
    <div className="p-6 bg-gray-100 min-h-screen">
      ...
      <div className="bg-white shadow-md rounded-lg overflow-hidden">
        <ul className="divide-y divide-gray-200">
          {isLoading && vehicles.length === 0 && <li className="p-4 text-center text-gray-500">Đang tải...</li>}
          {!isLoading && error && vehicles.length === 0 && <li className="p-4 text-center text-red-500">{error}</li>}
          {!isLoading && !error && vehicles.length === 0 && (
            <li className="p-4 text-center text-gray-500">Chưa có phương tiện nào.</li>
          )}
          {vehicles.map((vehicle) => (
            <li key={vehicle.id} className="p-4 hover:bg-gray-50 flex justify-between items-center transition-colors">
