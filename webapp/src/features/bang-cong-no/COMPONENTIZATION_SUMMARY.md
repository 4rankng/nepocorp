...
import { useTransactionModal, useFinancialLedger } from '@/features/bang-cong-no/hooks';
...
_Generated on $(date) as part of the Bang Cong No componentization project_
