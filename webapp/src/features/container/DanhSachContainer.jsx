...
const PencilIcon = ({ className = "w-5 h-5" }) => ( // Slightly smaller for table actions
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M16.862 4.487l1.687-1.688a1.875 1.875 0 112.652 2.652L10.582 16.07a4.5 4.5 0 01-1.897 1.13L6 18l.8-2.685a4.5 4.5 0 011.13-1.897l8.932-8.931zm0 0L19.5 7.125M18 14v4.75A2.25 2.25 0 0115.75 21H5.25A2.25 2.25 0 013 18.75V8.25A2.25 2.25 0 015.25 6H10" />
  </svg>
);

const TrashIcon = ({ className = "w-5 h-5" }) => ( // Slightly smaller for table actions
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    ...
    <div className="p-6 bg-gray-100 min-h-screen">
      ...
      <div className="bg-white shadow-md rounded-lg overflow-hidden">
        <ul className="divide-y divide-gray-200">
          {isLoading && containerTypes.length === 0 && <li className="p-4 text-center text-gray-500">Đang tải...</li>}
          ...
          {containerTypes.map((type) => (
            <li key={type.id} className="p-4 hover:bg-gray-50 flex justify-between items-center transition-colors">
