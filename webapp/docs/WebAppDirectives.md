...
4. Show pagination in the standard table
5. Keep the UI design, just ccale down all component size and font size in webapp/src/features/lich-van-chuyen/components/DesktopShipmentFormDialog.jsx so that it can show more information in the table. Our aim is to reduce the scrolling area as much as possible. The title of the modal should be same color but bigger font size.
...
4. Shipments order per customers by date range.
