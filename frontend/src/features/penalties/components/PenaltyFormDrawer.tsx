      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
        ...
        <FormGroup label="Lý do chi tiết khác">
          ...
          {formCustomReason.length > 5 && (() => {
            ...
            return (
              <div style={{ fontSize: 'var(--fs-body)', lineHeight: 1.35, color: 'var(--brand)', marginTop: 4 }}>
                Đã có lý do tương tự:{' '}
                <button
                  type="button"
                  style={{ background: 'none', border: 'none', cursor: 'pointer', color: 'var(--brand)', fontWeight: 600, padding: 0, fontSize: 'var(--fs-body)', lineHeight: 1.35, textDecoration: 'underline' }}
