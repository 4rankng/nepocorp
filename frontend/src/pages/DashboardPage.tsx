    ...
    <div className="fade-up" style={styles.sectionPadding}>
      ...
      <div className="kpi-grid">
        ...
        <div className="kpi" onClick={() => navigate('/finance')}>
          ...
          <div className="kpi__watermark" aria-hidden="true">
            <svg width="80" height="80" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><line x1="3" y1="22" x2="15" y2="22"/><line x1="4" y1="9" x2="14" y2="9"/><path d="M14 22V4a2 2 0 0 0-2-2H6a2 2 0 0 0-2 2v18"/></svg>
          </div>
        </div>
        ...
        <div className="kpi kpi--success" onClick={() => navigate('/finance')}>
          ...
          <div className="kpi__watermark" aria-hidden="true">
            <svg width="80" height="80" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><polyline points="23 6 13.5 15.5 8.5 10.5 1 18"/><polyline points="17 6 23 6 23 12"/></svg>
          </div>
        </div>
        ...
        <div className="kpi kpi--accent" onClick={() => navigate('/profit')}>
          ...
          <div className="kpi__watermark" aria-hidden="true">
            <svg width="80" height="80" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"/><polyline points="8 12 11 15 16 9"/></svg>
          </div>
        </div>
      </div>
