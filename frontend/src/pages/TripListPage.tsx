...
function buildTripCode(trip: TripDetail): string {
  // Prefer the canonical TRP-YYYYMM-NNNN code generated by the backend so
  // audit messages, customer statements, and the trip detail page all match
  // what users see in the list. Fall back to a legacy fabricated label only
