...
const ADMIN_BASE_ITEMS: SearchItem[] = [
  ...
  { id: 'fleet',    type: 'page', label: 'Đội xe',                  path: '/fleet',     iconName: 'truck' },
  ...
  { id: 'profit',   type: 'page', label: 'Phân chia lợi nhuận',     path: '/profit',    iconName: 'analytics' },
  { id: 'debt',     type: 'page', label: 'Công nợ phải thu',        path: '/debt',      iconName: 'receivables' },
  { id: 'payables', type: 'page', label: 'Công nợ phải trả',        path: '/payables',  iconName: 'receivables' },
  { id: 'expenses', type: 'page', label: 'Chi phí phát sinh',       path: '/expenses',  iconName: 'expense' },
  { id: 'advances', type: 'page', label: 'Tạm ứng',                 path: '/advances',  iconName: 'expense' },
...
export const CONFIG_ITEMS: SearchItem[] = [
  ...
  { id: 'cap-table',              type: 'config', label: 'Thông tin công ty & Cổ phần',   description: 'Mã số thuế, địa chỉ, người đại diện và tỷ lệ vốn góp giữa các đối tác cổ đông.',                path: '/config/cap-table',           iconName: 'checklist',    action: 'Xem' },
  ...
  { id: 'routes',                 type: 'config', label: 'Tuyến đường & Cự ly',           description: 'Danh sách các tuyến chặng, số trạm thu phí BOT, quãng đường di chuyển chuẩn.',                    path: '/config/routes',              iconName: 'route',        action: 'Sửa' },
  { id: 'trucks',                 type: 'config', label: 'Xe đầu kéo',                   description: 'Biển số các đầu kéo kéo container đang vận hành, định mức mặc định và lịch bảo dưỡng đầu xe.',     path: '/config/trucks',              iconName: 'truck',        action: 'Sửa' },
  { id: 'tire-positions',         type: 'config', label: 'Vị trí lốp',                    description: 'Danh mục vị trí lốp dùng khi thêm hoặc cập nhật lốp trên xe.',                                   path: '/config/tire-positions',      iconName: 'settings',     action: 'Sửa' },
  { id: 'trailers',               type: 'config', label: 'Rơ-moóc',                      description: 'Danh sách rơ-moóc, loại rơ-moóc và thông tin đăng kiểm.',                                          path: '/config/trailers',            iconName: 'truck',        action: 'Sửa' },
  ...
  { id: 'pricing-tables',         type: 'config', label: 'Bảng giá cước',                 description: 'Bảng giá cước chi tiết thỏa thuận với từng đối tác khách hàng trên mỗi tuyến.',                  path: '/config/pricing-tables',      iconName: 'document',     action: 'Sửa' },
...
const ACTION_ITEMS: SearchItem[] = [
  ...
  { id: 'action-audit-logs', type: 'action', label: 'Xem nhật ký hoạt động',    path: '/audit-logs',   iconName: 'document' },
...
const FORWARDER_ITEMS: SearchItem[] = [
  ...
  { id: 'my-advances',        type: 'page', label: 'Tạm ứng',           path: '/my-advances',        iconName: 'expense' },
  { id: 'my-settlements',     type: 'page', label: 'Phiếu thanh toán',  path: '/my-settlements',     iconName: 'document' },
];
