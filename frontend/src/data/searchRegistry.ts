...
export const CONFIG_ITEMS: SearchItem[] = [
  ...
  { id: 'cap-table',              type: 'config', label: 'Cổ phần & vốn góp',             description: 'Tỷ lệ vốn góp giữa các đối tác cổ đông dùng cho phân chia lợi nhuận.',                         path: '/config/cap-table',           iconName: 'checklist',    action: 'Xem' },
