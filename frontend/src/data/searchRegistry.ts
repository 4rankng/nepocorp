...
export const CONFIG_ITEMS: SearchItem[] = [
  ...
  { id: 'drivers', type: 'config', label: 'Người dùng & tài xế', description: 'Quản lý tài khoản lái xe, lương cơ bản, xe phụ trách và thông tin hồ sơ liên hệ.', path: '/users', icon: UserCheck, action: 'Sửa' },
