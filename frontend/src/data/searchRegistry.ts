...
const ADMIN_BASE_ITEMS: SearchItem[] = [
  ...
  { id: 'advances', type: 'page', label: 'Tạm ứng',                 path: '/advances',  iconName: 'advances' },
...
export const CONFIG_ITEMS: SearchItem[] = [
  ...
  { id: 'tire-positions',         type: 'config', label: 'Vị trí lốp',                    description: 'Danh mục vị trí lốp dùng khi thêm hoặc cập nhật lốp trên xe.',                                   path: '/config/tire-positions',      iconName: 'tire',         action: 'Sửa' },
  { id: 'trailers',               type: 'config', label: 'Rơ-moóc',                      description: 'Danh sách rơ-moóc, loại rơ-moóc và thông tin đăng kiểm.',                                          path: '/config/trailers',            iconName: 'trailer',      action: 'Sửa' },
  ...
  { id: 'llm-settings',          type: 'config', label: 'Nhà cung cấp AI',              description: 'Chọn nhà cung cấp LLM (MiniMax / OpenRouter) cho trợ lý ảo và cấu hình API key. Mã hóa AES-256 khi lưu.', path: '/config/llm-settings',          iconName: 'ai-provider', action: 'Sửa', adminOnly: true },
  ...
  { id: 'app-settings',          type: 'config', label: 'Cài đặt ứng dụng',               description: 'Bật/tắt các tính năng áp dụng trên toàn hệ thống, gồm Trợ lý ảo và Hướng dẫn sử dụng.',                  path: '/config/app-settings',          iconName: 'app-settings', action: 'Sửa', adminOnly: true },
];
