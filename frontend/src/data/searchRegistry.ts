...
export const CONFIG_ITEMS: SearchItem[] = [
  ...
  { id: 'fuel-suppliers',         type: 'config', label: 'Nhà cung cấp dầu',              description: 'Quản lý các cây dầu xuất hiện trong phần phân bổ nơi đổ dầu của chuyến xe.',                         path: '/config/fuel-suppliers',      iconName: 'fuel',         action: 'Quản lý' },
